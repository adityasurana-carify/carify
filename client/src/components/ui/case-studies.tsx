  ...
  const caseStudies = [
    {
      id: 1,
      quote:
        "With Carify Health, our front desk team finally has time to focus on patient care. Jenny handles 80% of our calls, and we've reduced no-shows by 60%.",
      name: "Dr. Sarah Chen",
      ...
      icon: Monitor,
      metrics: [
        { value: "80%", label: "Calls Handled", sub: "By AI coordinator Jenny" },
        { value: "60%", label: "No-Show Reduction", sub: "Automated reminders & confirmations" },
      ],
    },
    {
      id: 2,
      quote:
        "Carify's AI insurance verification saved us 3 hours daily. Our staff can now focus on complex cases while Jenny handles routine benefits checks seamlessly.",
      ...
      metrics: [
        { value: "3", label: "Hours Saved Daily", sub: "Per staff member" },
        { value: "95%", label: "Verification Accuracy", sub: "Automated insurance checks" },
      ],
    },
    {
      id: 3,
      quote:
        "The patient experience transformed completely. Jenny's natural conversations and 24/7 availability increased our patient satisfaction scores by 40%.",
      ...
      icon: Users,
      metrics: [
        { value: "40%", label: "Satisfaction Increase", sub: "Patient experience scores" },
        { value: "24/7", label: "Availability", sub: "Always-on patient support" },
      ],
    },
  ];
    ...
    >
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col gap-4 text-center max-w-2xl mx-auto">
          ...
          >
            Real results with Carify Health
          </h2>
          <p className="text-muted-foreground">
            From busy practices to large clinics—Carify Health powers healthcare teams with efficiency,
