      ...
      <div className="flex flex-col-reverse items-center justify-between gap-10 md:flex-row">
        <div className="z-10 max-w-xl text-left">
          <h1 className="text-3xl font-normal text-gray-900 dark:text-white">
            Transform Healthcare with <span className="text-primary">Carify Health</span>{" "}
            <span className="text-gray-500 dark:text-gray-400">Empower your healthcare team with AI-powered solutions that handle 75% of calls, save 2+ hours daily, and reduce no-shows to less than 5%.</span>
          </h1>
